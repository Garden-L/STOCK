...
df=getPSR(df)
df=getPCR(df)
s1 = df_filter(df, 'PER', min= 1, n=400, asc = True) #하위 50종목
s2 = df_filter(df, 'PBR', min=0.1,  n=400, asc= True) # 하위 50종목
s3 = df_filter(df, 'PSR', min=0.1,  n=400, asc= True) # 하위 50종목
s4 = df_filter(df, 'PCR', min=0.1, n=400, asc= True) # 하위 50종목
